                    ...
                    <div className='bg-white py-6 px-4 space-y-6 sm:p-6'>
                        ...
                        <div className='grid grid-cols-6 gap-6'>
                            ...
                            <div className='col-span-6'>
                                ...
                                <div className='mt-1'>
                                    <div
                                        className='shadow-sm flex flex-col flex-wrap p-5 mt-1 w-full max-h-80 sm:text-sm border border-gray-300 rounded-md'>
