                      ...
                      >
                        ...
                        <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                          ...
                          />
                                ...
                                <Link href={'/register'}>
                                    <a className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-main-600 hover:bg-main-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-main-500">
                                        Регистрация
                                    </a>
                                </Link>
                            </div>
