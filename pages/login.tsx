            ...
            <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    ...
                    <div className="mt-8">
                        <div>
                            <div>
                                <Link href={'/register'} className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-main-600 hover:bg-main-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-main-500">
                                    Регистрация
                                </Link>
                            </div>
                        ...
                        <div className="mt-6">
                            ...
                            >
                                <div>
                                    ...
                                    {errField === 'email' ? (
                                        <span className="text-red-500 text-sm errMsg">
                                            {errMessage}
                                        </span>
                                    ) : (
                                        ''
