...
const Book = () => {
  ...
  return (
    <div className='space-y-10'>
      ...
      <h1 className='text-2xl text-center text-white font-semibold'>{edition.title}</h1>
      <div className='sm:grid gap-6 sm:grid-cols-6'>
        ...
        <div className='col-span-2 mt-4 sm:mt-0'>
          <div className='bg-white p-4 shadow sm:rounded-md border'>
            ...
            <p className='font-medium'>Подписаться на оповещения</p>
            {
      ...
      <div>
        <div>
          <p className='text-xl text-center font-medium'>Книги</p>
          {
