module.exports = {
  ...
  theme: {
    fontFamily: {
      'logo': ['Rubik', 'ui-sans-serif', 'system-ui', '-apple-system'],
      ...
      'serif': ['Noto Serif', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', "Segoe UI", 'Roboto', "Helvetica Neue", 'Arial', "Noto Sans", 'sans-serif', "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"],
    },
    extend: {
      colors: {
        orange: {
